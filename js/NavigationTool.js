...
class NavigationTool {
  ...
  initialize( cannonBody ) {
    this.createUI();

    //const controls = new CannonPointerLockControls( this.camera, cannonBody );
    const controls = new THREE.CannonPointerLockControls( this.camera, null, cannonBody );
  ...
  update( scene, callback ) {
    ...
    // const delta = diff / 1000; // 大約為 0.016
